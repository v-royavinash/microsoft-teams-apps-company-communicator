...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    {
        private const string TeamsLicenseId = "9953b155-8aef-4c56-92f3-72b0487fce41";
        ...
        private IEnumerable<BatchRequestContent> GetBatchRequest(IEnumerable<IEnumerable<string>> userIdsByGroups)
        {
            ...
            foreach (var userIds in userIdsByGroups)
            {
                ...
                var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, $"https://graph.microsoft.us/v1.0/users?$filter={filterUserIds}&$select=id,displayName,userPrincipalName,userType");
